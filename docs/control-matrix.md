...
| AC-7 | Unsuccessful Logon Attempts | I | Account lockout after 5 consecutive failures; 15-minute auto-unlock; alerts to admin; per-account regardless of source IP | System (Automated) | Lockout Configuration; Alert Config; Audit Logs |
| AC-8 | System Use Notification | I | Warning banner on login page; text configurable by admin; informs of authorized use, monitoring, and penalties | Sys Admin / ISSO | Login Page Template; Banner Text Configuration |
